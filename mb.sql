...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=3699542962ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=mb&table=students">`mb`.`students`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=mb&table=answered">`mb`.`answered`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=mb&table=teachers">`mb`.`teachers`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=mb&table=unanswered">`mb`.`unanswered`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=mb&table=homeques">`mb`.`homeques`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=mb&table=unans">`mb`.`unans`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=test&table=tablechk">`test`.`tablechk`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=test&table=TableChk">`test`.`TableChk`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="5b5e743c7b684152512e6a663e72576c">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="mb" targettable="answered">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `answered`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="mb" targettable="students">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `students`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="mb" targettable="teachers">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `teachers`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="mb" targettable="teachers">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `teachers`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="mb" targettable="unanswered">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `unanswered`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="mb" targettable="answered">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `answered`  
ORDER BY `answered`.`s_no`  ASC</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="mb" targettable="answered">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">DELETE FROM `teachers` WHERE `teachers`.`s_no` = 6</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="mb" targettable="answered">
                            <div class="action_content">
